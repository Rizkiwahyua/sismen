...
@section('content')
    <div class="max-w-4xl mx-auto pb-12">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-xl font-bold text-slate-800 tracking-tight">Tambah Dokumen Baru</h2>
                <p class="text-xs text-slate-400 mt-0.5">Lengkapi form di bawah untuk mendaftarkan dokumen baru ke sistem</p>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="document_category_id" id="document_category_select"
                        ...
                        <div>
                            ...
                            <select name="document_code_id"
                                ...
                                @foreach ($codes as $code)
                                    <option value="{{ $code->id }}" {{ old('document_code_id') == $code->id ? 'selected' : '' }}>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="revision" value="{{ old('revision', '0') }}"
                                class="w-full px-4 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 text-slate-800 transition duration-150"
                        ...
                        <div>
                            ...
                            <label for="file_document"
                                ...
                                <span class="text-xs font-bold text-slate-700 group-hover:text-indigo-650">Pilih Berkas Dokumen</span>
                                <span class="text-[10px] text-slate-400 font-semibold">PDF, DOC, DOCX, XLS, XLSX (Maks. 50MB)</span>
                            ...
                            <div id="file-name-preview" class="hidden w-full mt-2 bg-indigo-50/60 border border-indigo-100/50 rounded-xl px-4 py-2 flex items-center justify-between text-xs text-indigo-700 font-bold transition duration-150 shadow-sm">
                                <span class="truncate pr-4 flex items-center gap-1.5">
                                    <i class="bi bi-file-earmark-check-fill text-indigo-500 text-sm"></i>
                    ...
                    <div class="col-span-1 md:col-span-2 bg-slate-50/50 border border-slate-200/60 rounded-xl p-4.5 space-y-3">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch gap-2">
                            ...
                            <div class="flex-1">
                                <input type="text" name="document_number_prefix" id="doc_num_prefix" 
                                    value="{{ old('document_number_prefix', 'PI-SMT') }}"
                            ...
                            <div class="flex-1">
                                <input type="text" name="document_number_suffix" id="doc_num_suffix" 
                                    value="{{ old('document_number_suffix') }}"
                                    class="w-full px-3 py-2 text-xs bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 text-slate-800 transition"
                        ...
                        <div class="text-[11px] text-slate-550 font-semibold flex items-center gap-1.5 bg-white border border-slate-200/50 rounded-lg px-3 py-2">
                            ...
                            <span id="doc_num_preview" class="text-indigo-650 font-bold tracking-wider"></span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description"
                        ...
                        placeholder="Tuliskan keterangan detail mengenai dokumen ini...">{{ old('description') }}</textarea>
                </div>
                ...
                <div id="subDetailSection" class="space-y-4 pt-4 border-t border-slate-100">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400 font-medium">Buat daftar sub judul beserta unit kerja terkait jika dibutuhkan</p>
                        </div>
                    ...
                    <div id="subContainer" class="space-y-3.5">
                        <!-- INITIAL ROW -->
                        <div class="flex flex-col sm:flex-row gap-3 bg-slate-50/50 border border-slate-200/60 rounded-xl p-4 relative group">
                            
                            <!-- Sub Judul -->
                            <div class="flex-1">
                                <label class="block text-[9px] font-bold text-slate-400 uppercase tracking-wider mb-1">Sub Judul / Uraian</label>
                                <input type="text" name="sub_title[0]" placeholder="Masukkan sub judul..."
                            ...
                            <div class="w-full sm:w-60">
                                ...
                                <button type="button" onclick="openDepartmentModal(0)"
                                ...
                                <input type="hidden" name="sub_department[0]" id="sub_department_0" value="[]">
                                <div id="selected_departments_0" class="flex flex-wrap gap-1 mt-1.5">
                                    <!-- Dynamic badges list -->
                                </div>
                            </div>
                            ...
                            <div class="flex-1">
                                ...
                                <input type="text" name="sub_description[0]" placeholder="Keterangan singkat..."
                                    class="w-full px-3 py-2 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 text-slate-800 bg-white transition shadow-sm">
                            </div>

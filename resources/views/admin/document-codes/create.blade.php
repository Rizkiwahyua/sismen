...
@section('content')
    <div class="max-w-xl mx-auto pb-12">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-xl font-bold text-slate-800 tracking-tight">Tambah Kode Dokumen</h2>
                <p class="text-xs text-slate-400 mt-0.5">Daftarkan kode klasifikasi baru untuk penomoran dokumen</p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 md:p-8">
            ...
            <form method="POST" action="{{ route('admin.document-codes.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 mt-1.5 font-medium">Gunakan huruf kapital dan singkat tanpa spasi (misal: PI-SMT)</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 mt-1.5 font-medium">Penjelasan deskriptif dari arti kode klasifikasi di atas</p>
                </div>

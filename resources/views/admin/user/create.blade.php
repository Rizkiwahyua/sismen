...
<div class="py-6 max-w-4xl mx-auto px-4 sm:px-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-[#0f3c7a] to-[#164d94] px-6 py-5 text-white">
            <h2 class="text-lg font-bold tracking-tight">Tambah Pengguna Baru</h2>
            <p class="text-slate-200 text-xs mt-1">Lengkapi formulir di bawah ini untuk membuat akun pengguna baru di dalam sistem.</p>
        </div>

        <!-- Form Body -->
        <div class="p-6">
            <form action="{{ route('admin.user.store') }}" method="POST" autocomplete="off" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <!-- Password Kunci -->
                    <div class="col-span-1 md:col-span-2">
                        <label for="password" class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Password <span class="text-rose-500">*</span></label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
